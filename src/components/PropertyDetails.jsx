    ...
    <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="text-3x1 font-semibold text-violet-600">
            $ {house.price}
          </div>
        </div>
          ...
          <div className="flex items-center gap-x-4 mb-8">
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <input
                ...
                placeholder="Celular"
              />
              <textarea className="border border-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400" placeholder="Mensaje" defaultValue="Hello, I am intersted in [Modern apartment]"></textarea>
